...
This guide assumes that you have a Fedora 34 server or workstation system configured to run Cobbler v3.3.7 similarly to the [Cobbler v3.3.7 Beginner's guide](/_post/2024/2024-11-12-Cobbler-v3.3.7-Beginners-Guide.md).
