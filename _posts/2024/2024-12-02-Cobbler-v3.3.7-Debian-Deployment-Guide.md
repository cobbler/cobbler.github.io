...
This guide assumes that you have a Fedora 34 server or workstation system configured to run Cobbler v3.3.7 similarly to the [Cobbler v3.3.7 Beginner's guide](/blog/2024/11/12/Cobbler-v3.3.7-Beginners-Guide.html).
...
1. The [Cobbler 3.3.7 Beginner's Guide](/blog/2024/11/12/Cobbler-v3.3.7-Beginners-Guide.html) **Tips & Troubleshooting** section contains some basic recommendations and limitations of Cobbler which will not be repeated here.
