...
If enabled, Cobbler will allow settings to be modified on the fly without a restart to the cobblerd daemon. Please reference the {% linkup title:"Dynamic Settings" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Anaconda Monitoring" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Managing DNS" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Build ISO" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Replicate" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Package Management and Mirroring" extrameta:2.6.0 %} section for more details.
...
The default kickstart file to use if no other is specified. This option is effectively deprecated, as the default kickstart to use is now specified in the distro signatures configuration file. Please see the {% linkup title:"Distro Signatures" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Web Authorization" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Alternative Template Formats" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Koan" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Using gPXE" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Func Integration" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Kerberos Authentication" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"LDAP Authentication" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Managing DHCP" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Managing TFTP" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Configuration Management" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Multi-Homed Cobbler Servers" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Power Management" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Puppet Integration" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Spacewalk Authentication" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Tips For RHN" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Automatic Registration" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Reposync" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Triggers" extrameta:2.6.0 %} section for more details.
...
Please refer to the {% linkup title:"Data Revision Control" extrameta:2.6.0 %} section for more details.
