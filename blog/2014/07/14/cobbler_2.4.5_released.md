...
<head>
   ...
   <title>Cobbler 2.4.5 Released</title>
  ...
  <div class="span9">
   <div class="row-fluid">
    <ul class="pager">
     ...
     <li class="previous"><a href="/blog/2014/07/15/cobbler_2.6.2_released.html"><i class="icon-angle-left"></i> Cobbler 2.6.2 Released</i></a></li>
     
     
     <li class="next"><a href="/blog/2014/05/22/cobbler_2.6.1_released.html">Cobbler 2.6.1 Released <i class="icon-angle-right"></i></a></li>
     
    </ul>
   </div>
   <div class="row-fluid posts">
    <div class="post">
     <h2 class="header">Cobbler 2.4.5 Released</h2>
     <div class="author"><i>Posted by Jörgen on Monday, July 14, 2014</i></div>
     <div class="content"><p>Cobbler 2.4.5 is now officially available!</p>

<p>Improved Features:</p>

<ul>
<li>Add support for importing Enterprise Linux 7 (RHEL/CentOS)</li>
<li>Add support for importing CloudLinux 6</li>
</ul>
...
<ul>
<li>Minor improvement to LDAPS configuration, fixes #217</li>
<li>pre_install_network_config snippet: only use slaves with a valid MAC address</li>
<li>remove colon from VLAN regex pattern</li>
</ul>


<p>The (source) release can be found <a href="https://github.com/cobbler/cobbler/releases/tag/v2.4.5">here</a></p>
...
<li><a href="http://download.opensuse.org/repositories/home:/libertas-ict:/cobbler24/Fedora_20/">Fedora 20</a></li>
     ...
     <script type="text/javascript">
        ...
        var disqus_identifier = '/posts/2014/07/14/cobbler_2.4.5_released';
